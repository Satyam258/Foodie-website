...
const Wws = () => {
    ...
    px-4 sm:px-6 lg:px-20 py-12 md:py-20 xl:py-24'>
            <div className='mx-auto text-center max-w-7xl'>
                <h2 className='text-2xl sm:texr-3xl lg:text-4xl font-bold text-red-600 uppercase
                    ...
                    {[
                        ...
                        <div key={index} className='group relative rounded-xl p-4 sm:p-6 transition-transform duration-300'>
                            <div className='overflow-hidden'>
                                <img src={service.img} alt={service.title} className='w-full hover:row-end-7 h-49 sm:h-56
                                md:h-48 lg:h-56 xl:h-64 object-contain lg:object-cover transition-transform duration-300'/>
                            </div>
