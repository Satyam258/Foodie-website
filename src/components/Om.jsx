...
const Om = () => {
    ...
    sm:px-5 md:px-8 lg:px-8 flex flex-col md:flex-col lg:flex-row items-center gap-8'>
            {/* Left SideBar */}
            <div className="w-full md:w-3/4 lg:w-1/4 bg-white p-4 md:p-6
        rounded-3xl shadow-lg border border-amber-300">
                <h1 className="text-3xl md:text-4xl font-pacifico text-amber-600 mb-4 md:mb-4 uppercase text-center">
                    Our Menu
                </h1>
                ...
                <div className="space-y-3 md:space-y-4">
                    ...
                    w-full p-2 md:p-3 rounded-2xl transition-all duration-300 ${selectedItem.name == item.name
                                ...
                                "bg-white text-gray-800 border border-amber-300"} hover:bg-amber-500 hover:text-white shadow-md`}>
                            <div className="flex items-center space-x-2 md:space-x-3">
                                {/* ICONS CONTAINER */}
                                <div className={`w-10 h-10 md:h-12 flex items-center justify-center
            ...
            <div className="w-full lg:w-3/4 flex flex-col items-center">
                <div className="relative flex flex-col md:flex-row gap-4 md:gap-6">
                    <div className="p-2 md:p-4 rounded-3xl">
                        <img src={selectedItem.image1} alt={`${selectedItem.name}1`} className="w-full md:w-[400px] h-auto object-cover rounded-xl" />
                    </div>
                    <div className="p-2 md:p-4 rounded-3xl">
                        <img src={selectedItem.image2} alt={`${selectedItem.name}2`} className="w-full md:w-[400px] lg:w[460px] h-auto object-cover rounded-xl" />
                    </div>
                </div>
                ...
                const currentIndex = menuItems.findIndex(
                    ...
                    }} className="p-2 md:p-3 bg-amber-600 text-white rounded-full
                    shadow-lg hover:bg-amber-500 transition">
                        <FaChevronRight size={18}/>
                    </button>
            </div>
            {/* Additional icon */}
            <div className="mt-4 md:mt-6 flex items-center space-x-3 md:space-x-4 lg:space-x-6 cursor-pointer">
                <div className="flex items-center justify-center p-2 md:p-3 bg-white rounded-full
                shadow-xl transform transition hover:scale-110">
