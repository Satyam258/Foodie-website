...
const Banner = () => {
  ...
  return (
    <div className='bg-white pt-12 md:pt-24 min-h-[500px] flex items-center'>
        ...
        justify-center p-4'>
            <div className='bg-white p-4 md:p-8 rounded-lg w-full msx-w-4xl relative'>
        ...
        lg:flex flex-row items-center justify-between gap-12'>
            {/* LEFT CONTENT */}
            <div className='w-full lg:flex-1 text-center lg:text-left'>
                ...
                <div className='flex flex-wrap justify-center lg:justify-start gap-4'>
                    ...
                    rounded-full hover:bg-red-600 transition hover:scale-105 text-sm md:text-base cursor-pointer'>
                        Get Started
                    </button>
                    <button className='flex items-center gap-2 md:gap-3 group '
                    onClick={()=> setShowVideo((true))}>
                        <span className='w-10 h-10 md:h-12 bg-red-500 rounded-full flex items-center
                        ...
                        <span className='text-gray-600 group-hover:text-red-500 font font-semibold
                        text-sm md:text-base'>Watch Video</span>
                    </button>
                </div>
                <div className='flex flex-col sm:flex-row items-center sm:items-center gap-4 mt-6'>
                    <div className='flex -space-x-3'>
                        <img src={Bannersmall1} alt="cutomer" className='w-10 h-10 md:w-12 md:h-12 rounded-full
                        border-2 border-white shadow-md'/>
                        <img src={Bannersmall2} alt="cutomer" className='w-10 h-10 md:w-12 md:h-12 rounded-full
                        border-2 border-white shadow-md'/>
                        <img src={Bannersmall3} alt="cutomer" className='w-10 h-10 md:w-12 md:h-12 rounded-full
                        border-2 border-white shadow-md'/>
                    </div>
                    <div>
                        <p className='text-lg md:text-xl font-bold flex items-center'>
                            <span className='text-yellow-500 mr-2'>&#x2605;&#x2605;&#x2605;&#x2605;&#x2605;</span>6.9k
                        </p>
            ...
            {/* Right section */}
            <div className='w-full lg:flex-1 relative max-w-sm sm:max-w-lg lg:max-w-none mx-auto'>
                <div className='relative mx-auto'>
                    ...
                    <div className='absolute left-2 sm:left-4 md:-left-6 top-4 w-14 sm:w-16 md:w-20'>
