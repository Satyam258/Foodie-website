...
const Wts = () => {
    ...
    from-orange-50 to-amber-50 relative overflow-hidden'>
        ...
        flex flex-col md:flex-row items-center gap-6 md:gap-8 lg:gap-12 xl:gap-16'>
                {/* Mobile Content */}
                <div className='w-full md:w-1/2 order-2 md:order-1 mb-6 md:mb-10 md:-ml-20 lg:-ml-24 xl:-ml-28
            transform hover:-translate-y-2 transition-all duration-300'>
                    <div className='relative group'>
                        <img src={Wts1} alt="Happy Customer" className='w-full h-auto
                    object-cover rounded-2xl shadow-2xl transform rotate-4 group-hover:rotate-0 transition-all
                    duration-300' style={{ maxWidth: "min(100%,640px" }} />
                        <div className='absolute -bottom-4 -right-4 sm:-bottom-6
                    sm:-right-6 md: -bottom-6 md:-right-2 bg-white p-2 sm:p-3 md:p-4
                ...
                <div className='w-full md:w-1/2 order-1 md:order-2'>
                    ...
                    md:p-10 lg:p-12 xl:p-14 shadow border-white/20 relative overflow-hidden'>
                        ...
                        text-gray-800 mb-4 sm:mb-6 lg:mb-8 leading-tight' style={{ fontFamily: "Dancing Script,cursive" }}>
                            ...
                            <div className='bg-white/40 rounded-xl p-4 sm:p-6 lg:p-8 mb-6
